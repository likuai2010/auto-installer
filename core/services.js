...
>>>>>>> 859e9913b7953cc15d74428a8c05857d08828775
...
class CoreService {
    ...
    accountInfo =  {
        steps: [
            { name: "登陆华为账号", finish: false, value:'17611576573',error:"未登录" },
            { name: "ClientID", finish: false, value:'xxx',error:"获取失败" },
            { name: "ClientKey", finish: false, value:'xxx',error:"获取失败" },
            { name: "创建应用", finish: false, value:'com.xx.xx',error:"创建失败" },
    ...
    buildInfo =  {
        ...
        install: [
            ...
            { name: "连接设备", finish: false,  error:'请连接手机，并开启开发者模式' },
