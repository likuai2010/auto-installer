...
class HdcCmdPageState extends State<HdcCmdPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('命令行工具'), actions: [IconButton(onPressed: (){
        setState(() {
          cmdResult = [];
        });
      ...
      child: Container(
            ...
            color: Colors.black,
            child: ListView.builder(itemCount: cmdResult.length, controller: listControrller, itemBuilder: (_, i){
      ...
      Padding(padding:
        ...
        child: Row(
            children: [ 
              Expanded(child: TextField(controller: cmdControrller, onSubmitted: (_){
                  sendCmd();
              },)), 
              SizedBox(width: 10),
              IconButton(onPressed: sendCmd, 
